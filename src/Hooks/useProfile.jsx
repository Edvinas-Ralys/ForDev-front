...
const {user} = useContext(Authorization)
  ...
  useEffect(_=>{
    ...
    axios.patch(`${SERVER_URL}/user`, updateProfile, headers)
      .then(res => {
        addMessage(res.data.message)
        if(updateProfile.updateType === `bio`){
          setProfile(prev => ({...prev, userDetails:{...prev.userDetails, bio:updateProfile.bio} }))
        }
  ...
  return {
    setGetProfile, loading, profile, setUpdateProfile
  }
}

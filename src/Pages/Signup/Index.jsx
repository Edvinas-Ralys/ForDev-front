          ...
          <div className="signup-form">
            ...
            <div className="form">
              ...
              <div className="form-element password-req">
                ...
                <ul>
                  <li
                    className={`${password.validations.charCount ? `validated` : `not-validated`}`}
                  >
                    At least 12 characters{" "}
                  </li>
                  <li
                    className={`${password.validations.uppercase ? `validated` : `not-validated`}`}
                  >
                    1 uppercaser letter
                  </li>
                  <li
                    className={`${password.validations.lowercase ? `validated` : `not-validated`}`}
                  >
                    1 lowercase letter
                  </li>
              ...
              <div className="sign-up-confirm">
                <div className="finepprint">
                  By clicking the Sign Up button below, you agree to <span>Terms of Service</span>{" "}
                  and acknowledge the <span>Privacy Notice</span>.
                </div>
